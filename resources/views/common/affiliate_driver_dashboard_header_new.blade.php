    ...
    <div style="display: flex; align-items: center">
      <div class="img--bordered img--shadow fixed-ratio fixed-ratio--1-1">
                        ...
                        <span style="font-size: 140%; opacity: 0.9; font-family: 'MontserratReg';font-weight: bold">{{ @Auth::user()->first_name}} {{ @Auth::user()->last_name}}</span>
                         <span style="font-size: 85%; opacity: 0.8; font-weight: bold; font-family: 'MontserratReg';">{{@Auth::user()->user_type}}</span>
                         <span style="font-size: 85%; opacity: 0.8; font-weight: bold; font-family: 'MontserratReg';"> {{ $result->referral_code }} </span>
                        </div>
