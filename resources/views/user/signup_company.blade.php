  ...
  <div class="join-page" >
    <div class="layout layout--join_company layout--hero layout_company_banner" >
      ...
      <a href="{{ url('/') }}">
        ...
        <p style="width: 70%; font-weight: 400; text-align: left;" >{{trans('messages.user.drive_with_RideOn')}} {{$site_name}} {{trans('messages.user.need_partner_content')}}
        </p>
      </div>
  ...
  <div class="col-md-12" >
    <div class="layout" >
      <div class="copyrightsection col-md-6 text-left hide" >
        <p >&copy; 2017 RideOn Technologies Inc.
        </p>
      </div>
