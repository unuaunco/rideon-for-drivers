          ...
          <div class="box box-info">
            ...
            <!-- form start -->
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-info pull-right" id="sbm-btn" data-toggle="modal" data-target="#exampleModal">Submit</button>
              </div>
              <!-- Modal -->
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body" id="mdl-bd">
                            ...
                        </div>
...
$('#sbm-btn').click(function()
{
    ...
    if(toval == "to_all"){
        $('#mdl-bd').html('<h2><span class="label label-danger">You are about to send messages to all users!</span></h2><h2><span class="label label-danger">Please check parameters before send it!</span></h4>');
    }
    else{
        $('#mdl-bd').html('<p>You are about to send message(s).</p> <p>Please check parameters before send it.</p>');
    }
});
