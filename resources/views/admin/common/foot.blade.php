...
@if (!isset($exception))
    ...
    @if (Route::current()->uri() == 'admin/add_merchant' || Route::current()->uri() == 'admin/edit_merchant/{id}')
		<script src="{{ url('admin_assets/dist/js/hideShowPassword.min.js') }}"></script>
	@endif
	...
	@if (Route::current()->uri() == 'admin/map' || Route::current()->uri() == 'company/map' || Route::current()->uri() == 'admin/detail_request/{id}' || Route::current()->uri() == 'company/detail_request/{id}')
		<script async defer type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key={{ $map_key }}&sensor=false&callback=initMap&libraries=geometry,places"></script>
	@endif
    ...
    @if (in_array(Route::current()->uri(), array('admin/shifts')))
        <script src="{{ url('admin_assets/dist/js/moment.min.js') }}"></script>
    ...
    @if (in_array(Route::current()->uri(), array('admin/payout_transactions', 'admin/add_home_delivery', 'admin/edit_home_delivery/{id}', 'admin/home_delivery_orders/{id}', 'company/edit_home_delivery/{id}')))
    {{-- Route::current()->uri() == 'admin/payout_transactions' || Route::current()->uri() == 'admin/add_home_delivery' ||  Route::current()->uri() == 'admin/edit_home_delivery/{id}' || Route::current()->uri() == 'admin/home_delivery_orders/{id}'|| Route::current()->uri() == 'company/edit_home_delivery/{id}') --}}
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key={{$map_key}}&sensor=false&libraries=places"></script>
        <script src="https://js.api.here.com/v3/3.1/mapsjs-core.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://js.api.here.com/v3/3.1/mapsjs-service.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://js.api.here.com/v3/3.1/mapsjs-mapevents.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://js.api.here.com/v3/3.1/mapsjs-ui.js" type="text/javascript" charset="utf-8"></script>
        <script src="{{ url('admin_assets/dist/js/delivery_order_here.js') }}"></script>
