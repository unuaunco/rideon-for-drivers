...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box" >
            <div class="box-header with-border">
                <h4 class="box-title">Driver Data</h4>
            </div>
            <div class="row" style="padding: 10px;">
                <input id='driver_id' type="hidden" value="{{@$driver->driver_id}}" style="display: none;" />
                <input id='driver_latitude' type="hidden" value="{{@$driver->driver_latitude}}" style="display: none;" />
                <input id='driver_longitude' type="hidden" value="{{@$driver->driver_longitude}}" style="display: none;" />
                <div class="col-md-3">
                    <pre>{{@$driver->driver_id}}</pre>
                </div>
                <div class="col-md-4">
                    <pre>{{@$driver->first_name}} {{$driver->last_name}}</pre>
                </div>
                <div class="col-md-3">
                    <pre>{{@$driver->mobile_number}}</pre>
                </div>
            </div>
        </div>
        @endif
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <pre>Real Pickup_Longitude : {{$real_location_result['real_pickup_longitude']}}</pre>
                                <pre>Real Pickup_time : {{$real_location_result['real_pickup_time']}}</pre>
                                ...
                                <pre>Real Drop_time : {{$real_location_result['real_drop_time']}}</pre>
                            </div>
                        </div>
