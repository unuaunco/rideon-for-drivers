...
<div class="content-wrapper" ng-controller="driver_management">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="{{ url(LOGIN_USER_TYPE.'/community_leader') }}"> Community Leaders </a>
			</li>
		...
		<div class="row">
			<div class="col-md-8 col-sm-offset-2 ne_ed">
				<div class="box box-info">
                    ...
                    {!! Form::open(['url' => LOGIN_USER_TYPE.'/edit_community_leader/'.$result->id, 'class' => 'form-horizontal','files' => true]) !!}
                    @if($referrer)
					...
					<div class="box-body ed_bld">
                        ...
                        <div class="form-group">
							<label for="input_right_to_work" class="col-sm-3 control-label">Right to work <em class="text-danger">*</em></label>
							<div class="col-sm-6">
								{!! Form::file('right_to_work', ['class' => 'form-control', 'id' => 'input_right_to_work', 'accept' => "image/*"]) !!}
								<span class="text-danger">{{ $errors->first('right_to_work') }}</span>
								<div class="license-img">
									@if(@$driver_documents->right_to_work)
									<a href="{{@$driver_documents->right_to_work }}" target="_blank"><img style="width: 200px;height: 100px" src="{{@$driver_documents->right_to_work }}"> </a>
									@else
									<img style="width: 100px;height: 100px; padding-top: 5px;" src="{{ url('images/driver_doc.png')}}">
									@endif
								</div>
                        ...
                        <div class="form-group">
							<label for="input_abn_number" class="col-sm-3 control-label">ABN number<em class="text-danger">*</em></label>
							<div class="col-sm-6">
								{!! Form::file('abn_number', ['class' => 'form-control', 'id' => 'input_abn_number', 'accept' => "image/*"]) !!}
								<span class="text-danger">{{ $errors->first('abn_number') }}</span>
								<div class="license-img">
									@if(@$driver_documents->abn_number)
									<a href="{{@$driver_documents->abn_number }}" target="_blank"><img style="width: 200px;height: 100px" src="{{@$driver_documents->abn_number }}"> </a>
									@else
									<img style="width: 100px;height: 100px; padding-top: 5px;" src="{{ url('images/driver_doc.png')}}">
									@endif
								</div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-8">
                                <div class="box-header with-border">
                                    ...
                                    <p>{{@$payout_credentials->payout_id}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input_bsb" class="col-sm-3 control-label">BSB number</label>
                            <div class="col-sm-6">
                                {!! Form::text('bsb',$payout_preference->routing_number, ['class' => 'form-control', 'id' => 'bsb', 'placeholder' => '110000']) !!}
                                <span class="text-danger">{{ $errors->first('bsb') }}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input_account_num" class="col-sm-3 control-label">Account number</label>
                            <div class="col-sm-6">
                                {!! Form::text('account_num',$payout_preference->account_number, ['class' => 'form-control', 'id' => 'account_num', 'placeholder' => '000123456']) !!}
                                <span class="text-danger">{{ $errors->first('account_num') }}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input_account_holder" class="col-sm-3 control-label">Account holder name</label>
                            <div class="col-sm-6">
                                {!! Form::text('account_holder',$payout_preference->holder_name, ['class' => 'form-control', 'id' => 'account_holder', 'placeholder' => 'Account holder name']) !!}
                                <span class="text-danger">{{ $errors->first('account_holder') }}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input_id_document" class="col-sm-3 control-label">Driver's ID document</label>
                            <div class="col-sm-6">
                                {!! Form::file('id_document', ['class' => 'form-control', 'id' => 'input_id_document', 'accept' => "image/*"]) !!}
                                <span class="text-danger">{{ $errors->first('id_document') }}</span>
                                <div class="license-img">
                                    @if(@$payout_preference->document_image)
                                        <a href="{{@$payout_preference->document_image }}" target="_blank"><img style="width: 200px;height: 100px" src="{{@$payout_preference->document_image }}"> </a>
                                    @else
                                        <img style="width: 200px;height: 100px;" src="{{ url('images/user.jpeg')}}">
                                    @endif
                                </div>
                            </div>
                        </div>
