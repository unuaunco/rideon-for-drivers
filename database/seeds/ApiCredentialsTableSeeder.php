...
class ApiCredentialsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('api_credentials')->insert([
            ...
            ['name' => 'rest_api_key', 'value' => 'AIzaSyAi1MxUOrw3ze_OAFNATrZjKh--JFsTruk', 'site' => 'Here'],
            ['name' => 'javascript_api_key', 'value' => 'AIzaSyAi1MxUOrw3ze_OAFNATrZjKh--JFsTruk', 'site' => 'Here'],
            ['name' => 'master_api_token', 'value' => 'AIzaSyAi1MxUOrw13ze_OAFNATrZjKh--JFsTruk', 'site' => 'SendBird'],
            ['name' => 'application_id', 'value' => 'AIzaSyAi1MxUOrw32ze_OAFNATrZjKh--JFsTruk', 'site' => 'SendBird'],
            ['name' => 'growsurf_api_key', 'value' => 'JTZKNMC6QKMJ4XZXCCCCBX9XMACYFA', 'site' => 'GrowSurf'],
