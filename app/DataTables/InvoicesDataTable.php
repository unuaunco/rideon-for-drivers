...
class InvoicesDataTable extends DataTable
{
    ...
    public function query(Transaction $model)
    {
        return  $model->join('users', function($join) {
                    ...
                    $join->on('merchants.user_id', '=', 'transactions.user_id');
                })
                ->select([
                    'transactions.id as id',
                    'merchants.invoicing_schedule as invoicing_schedule',
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('invoicing_schedule')->name('merchants.invoicing_schedule'),
