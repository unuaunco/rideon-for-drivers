...
class SubscribedDriverDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($subscribed_drivers) {
                $edit = (LOGIN_USER_TYPE=='company' || auth('admin')->user()->can('update_driver')) ? '<a href="'.url('admin/subscriptions/edit_driver/'.$subscribed_drivers->id).'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;' : '';
                return $edit;
            });
    }
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            ['data' => 'updated_at', 'name' => 'stripe_subscriptions.updated_at', 'title' => 'Updated At'],
