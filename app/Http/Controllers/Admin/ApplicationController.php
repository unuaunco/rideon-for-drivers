...
use App\DataTables\ApplicationAffiliateDataTable;
...
class ApplicationController extends Controller
{
    ...
    /**
     * Load Application for Affiliate
     *
     * @param array $dataTable  Instance of Driver DataTable
     * @return datatable
     */
    public function affiliate(ApplicationAffiliateDataTable $dataTable)
    {
        return $dataTable->render('admin.application.view_affiliate');
    }
