...
class ApiCredentialsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ApiCredentials::where(['name' => 'growsurf_api_key','site' => 'GrowSurf'])->update(['value' => $request->growsurf_api_key]);
        ...
        ApiCredentials::where(['name' => 'rest_api_key','site' => 'Here'])->update(['value' => $request->here_rest_api_key]);
        ApiCredentials::where(['name' => 'javascript_api_key','site' => 'Here'])->update(['value' => $request->here_js_api_key]);

        ApiCredentials::where(['name' => 'master_api_token','site' => 'SendBird'])->update(['value' => $request->sendbird_master_api_token]);
        ApiCredentials::where(['name' => 'application_id','site' => 'SendBird'])->update(['value' => $request->sendbird_application_id]);
