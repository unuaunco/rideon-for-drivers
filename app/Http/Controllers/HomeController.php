...
class HomeController extends BaseController
{
	...
	public function index(){
        ...
        if (Auth::check()) {
            ...
            return redirect("driver/home"); //view('driver_dashboard.new_dash',$data)->with('title', 'Login');
        }
        else {
             return view('driver_dashboard.new_login')->with('title', 'Login');
        }
    ...
    public function test_vue(){
        return view('test_vue/test_vue');
    }



    /**
     * Redirect to the affiliate site home page
     *
    ...
    public function affiliate_index(){
        ...
        if (Auth::check()) {
            $data['result'] = User::find(@Auth::user()->id);
             ...
             return view('affiliate_driver_dashboard.new_login')->with('title', 'Login');
        }
    }

    /**
     * Redirect to the merchant site home page
     *
     * @return Static page view file
     */
    public function merchant_index(){
        if (Auth::check()) {
            ...
            return redirect("merchants/home");
             ...
             return view('merchants.new_login')->with('title', 'Log in');
        }
    }
    ...
    public function showLog()
    {
        ...
        $contents = \Storage::disk('logs')->get('/laravel.log');
