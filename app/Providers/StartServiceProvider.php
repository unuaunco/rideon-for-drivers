    ...
    public function registerReferralEvent()
    {
        ...
        ReferralUser::creating(function($referrel_user) {
            ...
            $user_type = $referrel_user->user_type;
             ...
             if(count($admin_referral_details) == 0 && $user_type == "Affiliate"){
                $referral_settings = new ReferralSetting;
                

                $referral_settings->name = "apply_referral";
                $referral_settings->value = "0";
                $referral_settings->user_type = "Affiliate";
